...
@section('controller','Đăng ký đại lý')
@section('controller_route',route('get.list.register'))
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
				...
				<form action="{{ route('register.post', $data->id) }}" method='POST' enctype="multipart/form-data" name="frmEditProduct">
