                ...
                <div class="col-sm-9">
					<div class="nav-tabs-custom">
		                <ul class="nav nav-tabs">
		                    <li class="active">
		                        <a href="#activity" data-toggle="tab" aria-expanded="true">Thông tin truyền thông</a>
							</li>
							<li class="">
									...
									<div class="col-sm-12">
										@if(isUpdate(@$module['action']))
											<div class="form-group" id="edit-slug-box">
												@include('backend.media.permalink')
											</div>
										@endif
									</div>
                                    <div class="col-sm-6">
				...
				<div class="col-sm-3">
					<div class="box box-success">
		                <div class="box-header with-border">
		                    <h3 class="box-title">Đăng truyền thông</h3>
		                </div>
		                <div class="box-body">
		                    <div class="form-group">
		            ...
		            <div class="box box-success">
		                <div class="box-header with-border">
		                    <h3 class="box-title">Ảnh truyền thông</h3>
						</div>
