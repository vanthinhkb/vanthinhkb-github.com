...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('truyen-thong/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('truyen-thong') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('truyen-thong') }}">
