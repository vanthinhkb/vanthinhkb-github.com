...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('tuyen-dung/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('tuyen-dung') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('tuyen-dung') }}">
