...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('du-an/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('du-an') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('du-an') }}">
