					...
					<div class="content-box content-breadcrumb">
						...
						<ul class="breadcrumb-box">
							...
							<li>
								...
								<span>{{ trans('message.truyen_thong') }}</span>
                            ...
                            <div class="blog-box">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{{ route('home.single-media', ['slug' => $item->slug]) }}" class="read-more">
                            ...
                            <div class="blog-box">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="project-link">
                                        ...
                                        <a href="{{ route('home.single-media', ['slug' => $item->slug]) }}">{{ trans('message.xem_them') }}</a>
