					...
					<div class="content-box content-breadcrumb">
						...
						<ul class="breadcrumb-box">
							...
							<li>
                                ...
                                <a href="{{ route('home.media') }}" title="{{ trans('message.truyen_thong') }}">{{ trans('message.truyen_thong') }}</a>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="blog-details-box">
                    ...
                    <div class="title-box title-blog-details">
                        ...
                        <div class="blog-create-date">
                            ...
                            <span>{{ trans('message.ngay_dang') }}</span>

                            <span>{{ app()->getLocale() == 'vi' ? $data->created_at->format('d/m/Y') : $data->created_at->format('M d, Y') }}</span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                @include('frontend.components.media-view-much')
