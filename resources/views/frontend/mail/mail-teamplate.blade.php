                    ...
                    <tr>
                      <td>
                        ...
                        @elseif ($type == 'register')
                            <p>Bạn vừa nhận được một yêu cầu đăng ký làm đại lý với thông tin như sau,</p>
                        @else
                            <p>Bạn vừa nhận được một yêu cầu đặt hàng với thông tin như sau,</p>
                        @endif
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="content-block">
        <span class="apple-link">HICHEM</span>
    </td>
</tr>
<tr>
