            ...
            <article class="sidebar-box art-sidebar-blogs">
                <div class="sidebar-blogs-box">
                    ...
                    <div class="sidebar-blogs-content">
                        @foreach ($post_view_much as $item)
                            <div class="item">
                                <div class="blog-box">
                                    <div class="blog-image">
                                        <a href="{{ route('home.single-news', ['slug' => $item->slug]) }}" title="{{ app()->getLocale() == 'vi' ? $item->name : $item->name_en }}">
                                            <img src="{{ $url.$item->image }}" alt="{{ app()->getLocale() == 'vi' ? $item->name : $item->name_en }}" style="max-width: 154px; max-height: 105px; width: 100%; height: 100%;">
                                        </a>
                                    </div>
